 ...
 *   Red Vision custom upload -> first frame only, 192x192
 *
 ...
 *
 *   /emotion_sheets_custom/<uniqueName>.png
 *
 ...
 *   1 frame
 *
 * It uses the first frame from the dashboard sprite.
...
createRedVisionSheetFromCustomEmotion(
  ...
  /*
   * Always take the first dashboard frame.
   * Dashboard sprites are horizontal, so frame 0
   * starts at x = 0.
   */
  const sourceX = 0;
  const sourceY = 0;
